...
import com.solo.practice.posting.mapper.PostingMapper;
import com.solo.practice.posting.service.PostingService;
import com.solo.practice.utils.UriCreator;
...
public class PostingController {
    ...
    public ResponseEntity postPosting(@RequestBody @Valid PostingDto.Post postingPostDto,
        ...
        return ResponseEntity.created(location).body(new SingleResponseDto<>(mapper.postingToPostingResponseDto(posting)));
    }
